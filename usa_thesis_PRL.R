...
# Create an age variable for the RDD models. This age variable refers to age in 2020, to match the coding of the run_rdd_models function
df <- df %>%
